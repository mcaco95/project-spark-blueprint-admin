...
const IndexContent = () => {
  ...
  const getTaskStats = () => {
    ...
    const upcomingDeadlines = 0; // In a real app, we'd filter by date
    
    return {
      activeProjects: 0, // This would come from a project context in a real app
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground">0 need attention</p>
          </CardContent>
          <CardFooter>
